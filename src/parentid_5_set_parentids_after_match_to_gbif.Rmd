...
It can be that the missing taxa we are going to add are children of missing parents. We should then check that the complete tree is fully included. So, we repeat this routine until no parent keys are missing;
