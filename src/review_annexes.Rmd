...
1. Retrieve and copypaste each annex species list in a [gsheets file](https://docs.google.com/spreadsheets/d/1Od5YYgMsTHvIFkrdeyWxkiARCya2yHKkAJrNM0-dnnw/edit#gid=1779940747). 

2. Import the annex species list in Rstudio.

3. To match the BIM species list with the annex species list, we need the _GBIF backbone_. In this way, we avoid nonmatches due to erroneous spelling or lacking authorship.
...
5. For now, remove all non-matching taxa (in summary)

5. Match BIM species list with the annex species list

*6. Remove all unverifiable records from the BIM species list

7. Results: species list with taxa occurring in BIM species list but not in the annex species list
  - due to synonyms?
  - due to unmatched taxa?
