...
Before testing connectivity be sure you have installed the [psqlodbc driver](https://www.postgresql.org/ftp/odbc/versions/msi/). We suggest to install the most recent drivers.
