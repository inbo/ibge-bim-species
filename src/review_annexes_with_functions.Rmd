...
Number of synonyms following GBIF Taxonomy Backbone :
...
Find accepted (scientific) names of synonyms in BIM annexes. Add them in column `gbif_accepted_name`. For accepted taxa, `gbif_accepted_name` = `gbif_scientificname`:
...
Create separate annexes and group them in a list of data.frames called `annexes`:
