...
We read taxa which we will further use to build the improved `taxa` table. In [previous pipeline](https://inbo.github.io/ibge-bim-species/parentid_2_detect_used_taxa.html) we added flag `used` to indicate whether the taxon is used in higher taxonomy or in linked tables.
